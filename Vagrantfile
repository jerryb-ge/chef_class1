...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "jbrignac2-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/jpborg"
  #   chef.validation_client_name = "jpborg-validator"
  #   chef.validation_key_path = ".chef/jpborg-validator.pem"
  # end
end
